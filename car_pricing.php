          ...
          <div class="card-body">
            <div class="table-responsive">
              <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                <thead>
                        <th>Car Type</th>
                        <th>Within Nairobi</th>
                        <th>Outside Nairobi</th>
                        <th>Loading Per Person</th>
                        <th>Action</th>
                    </thead>
                <tbody>
                        <?php
                            ...
                            while($row = $query->fetch_assoc()){
                                ...
                                "<tr>
                                    <td>".$row['car_type']."</td>
                                    <td>".$row['within_nairobi']."</td>
                                    <td>".$row['outside_nairobi']."</td>
                                    <td>".$row['loading_per_person']."</td>
                                     <td>
                                     <a href='#edit_".$row['car_type']."' class='btn btn-success btn-sm' data-toggle='modal'><span class='glyphicon glyphicon-edit'></span> Edit</a>
                                     <a href='#delete_".$row['car_type']."' class='btn btn-danger btn-sm' data-toggle='modal'><span class='glyphicon glyphicon-trash'></span> Delete</a>
                                    </td>
                                </tr>";
                                include('pricing_modal.php');
