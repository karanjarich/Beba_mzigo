        ...
        <div class="modal-content">
			...
			<form method="POST" action="edit_pricing.php">
				...
				<div class="row form-group">
					...
					<div class="col-sm-10">
						<input type="text" class="form-control" name="within_nairobi" value="<?php echo $row['within_nairobi']; ?>" required="required">
					</div>
				</div>
				<div class="row form-group">
					<div class="col-sm-2">
					...
					<div class="col-sm-10">
						<input type="text" class="form-control" name="outside_nairobi" value="<?php echo $row['outside_nairobi']; ?>" required="required">
					</div>
				</div>
				<div class="row form-group">
					<div class="col-sm-2">
					...
					<div class="col-sm-10">
						<input type="text" class="form-control" name="loading_per_person" value="<?php echo $row['loading_per_person']; ?>" required="required">
					</div>
				</div>
            </div> 
			</div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">	
				...
				<h2 class="text-center"><?php echo $row['car_type'].' '.$row['car_type']; ?></h2>
			</div>
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal"><span class="glyphicon glyphicon-remove"></span> Cancel</button>
                <a href="delete_pricing.php?car_type=<?php echo $row['car_type']; ?>" class="btn btn-danger"><span class="glyphicon glyphicon-trash"></span> Yes</a>
            </div>
